...
export const CONFIG_TAMPLAR = {
  ...
  // GEAMURI & OGLINZI — lista Krypton completa
  geamuriOglinzi: {
    "Geam float 3mm":       { pretMp:37 },
    "Geam float 4mm":       { pretMp:39 },
    "Geam float 5mm":       { pretMp:53 },
    "Geam float 6mm":       { pretMp:59 },
    "Geam float 8mm":       { pretMp:95 },
    "Geam float 10mm":      { pretMp:105 },
    "Geam ultraclar 4mm":   { pretMp:87 },
    "Geam ultraclar 6mm":   { pretMp:137 },
    "Geam fumuriu 4mm":     { pretMp:55 },
    "Geam fumuriu 5mm":     { pretMp:79 },
    "Geam fumuriu 6mm":     { pretMp:80 },
    "Geam Lacobel":         { pretMp:125 },
    "Geam vopsit alb":      { pretMp:135 },
    "Geam ornament import": { pretMp:70 },
    "Geam decorativ alb":   { pretMp:100 },
    "Geam decorativ fumuriu":{ pretMp:105 },
    "Geam reflexiv bronze": { pretMp:80 },
    "Geam lowe 4mm":        { pretMp:45 },
    "Geam 4 anotimpuri":    { pretMp:50 },
    "Oglinda 3mm":          { pretMp:54 },
    "Oglinda 4mm":          { pretMp:60 },
    "Oglinda bronze 4mm":   { pretMp:110 },
    "Oglinda/geam montat":  { pretMp:185 },
  },
